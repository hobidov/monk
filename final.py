...
with side_col:
    ...
    st.write(f"• Strongest outcome: {strongest['label']} ({strongest['value']}%)")
    st.write(f"• Weakest outcome: {weakest['label']} ({weakest['value']}%)")
    st.write(f"• Spark → Growth gap: {gap}%")
    st.write("• Recommendation: Focus on improving Social Growth through structured engagement activities.")
